...
public class TabPager extends HorizontalScrollView implements Pager {
    ...
    private final PagerLinearLayout mTabLayout;
    ...
    public TabPager(Context context, AttributeSet attrs) {
        ...
        mTabLayout = new PagerLinearLayout(context, R.attr.TabPager);
    ...
    private class TabView extends TextView {
        ...
        public TabView(Context context) {
            super(context, null, R.attr.TabPager);
        }
        ...
        public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (mMaxTabWidth > 0 && getMeasuredWidth() > mMaxTabWidth) {
                super.onMeasure(View.MeasureSpec.makeMeasureSpec(mMaxTabWidth, View.MeasureSpec.EXACTLY), heightMeasureSpec);
            }
        }
