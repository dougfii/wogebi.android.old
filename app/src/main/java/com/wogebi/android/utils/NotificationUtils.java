...
public class NotificationUtils
{
    ...
    public void sendNetworkNotification()
    {
        ...
        notification = new NotificationCompat.Builder(context)
                ...
                .setTicker(context.getString(R.string.notification_network_content))
                .setWhen(System.currentTimeMillis())
                .setContentTitle(context.getString(R.string.notification_network_title))
                .setContentText(context.getString(R.string.notification_network_content))
    ...
    public void sendLocatorNotification()
    {
        ...
        notification = new NotificationCompat.Builder(context)
                .setSmallIcon(R.mipmap.logo)
                .setTicker(context.getString(R.string.notification_location_content))
                .setWhen(System.currentTimeMillis())
                .setContentTitle(context.getString(R.string.notification_location_title))
                .setContentText(context.getString(R.string.notification_location_content))
                .setContentIntent(pendingIntent)
                .build();
