...
public class SignedAdapterBase extends BaseEntityAdapter
{
    public SignedAdapterBase(AppApplication application, Context context, List<? extends BaseEntity> entities)
    {
